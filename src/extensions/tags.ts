  ...
  renderHTML({ HTMLAttributes }) {
    return [
      ...
      mergeAttributes(this.options.HTMLAttributes, HTMLAttributes, {
        "data-tags": true,
        class:
          "inline-flex items-center rounded-md bg-gray-50 dark:bg-gray-800 p-1 text-xs font-medium text-gray-600 dark:text-gray-300 ring-1 ring-inset ring-gray-500/10 dark:ring-gray-500/20",
      }),
      0,
    ];
  },
